...
TMP_FILE = os.path.join(TMP_DIR, USERID+".jpg")
TMP_FILE_RCNN = os.path.join(TMP_DIR, USERID+"rcnn.jpg")
...
def classify_mqtt(load_file, save_file):
    ...
    # Visualize results
    r = results[0]
    inception(image, r['rois'], r['masks'], r['class_ids'], 
                                class_names, r['scores'], colors=colors, 
                                load_file=load_file, save_file=save_file)

def main():
    classify_mqtt(TMP_FILE, TMP_FILE_RCNN)
